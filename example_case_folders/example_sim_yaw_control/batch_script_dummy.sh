...
python emu_runscript.py emu_input_shortsim.yaml >> logemu 2>&1 & # Start the controller center and pass in input file


python emu_runscript_dummy_amr.py amr_input.inp >> logdummy 2>&1
